...
namespace CloudGameR.CountryDataSetTableAdapters {
    ...
    public partial class PaisTableAdapter : global::System.ComponentModel.Component {
        ...
        private void InitAdapter() {
            ...
            this._adapter.DeleteCommand.CommandText = "DELETE FROM [dbo].[Pais] WHERE (([Pais_ID] = @Original_Pais_ID) AND ([Nome] = @Or" +
                "iginal_Nome))";
            ...
            this._adapter.InsertCommand.CommandText = "INSERT INTO [dbo].[Pais] ([Pais_ID], [Nome]) VALUES (@Pais_ID, @Nome);\r\nSELECT Pa" +
                "is_ID, Nome FROM Pais WHERE (Pais_ID = @Pais_ID)";
            ...
            this._adapter.UpdateCommand.CommandText = "UPDATE [dbo].[Pais] SET [Pais_ID] = @Pais_ID, [Nome] = @Nome WHERE (([Pais_ID] = " +
                "@Original_Pais_ID) AND ([Nome] = @Original_Nome));\r\nSELECT Pais_ID, Nome FROM Pa" +
                "is WHERE (Pais_ID = @Pais_ID)";
        ...
        private void InitCommandCollection() {
            ...
            this._commandCollection[0].CommandText = "SELECT Pais_ID, Nome FROM dbo.Pais";
        ...
        public virtual int Fill(CountryDataSet.PaisDataTable dataTable) {
        ...
        public virtual CountryDataSet.PaisDataTable GetData() {
            this.Adapter.SelectCommand = this.CommandCollection[0];
            CountryDataSet.PaisDataTable dataTable = new CountryDataSet.PaisDataTable();
        ...
        [global::System.CodeDom.Compiler.GeneratedCodeAttribute("System.Data.Design.TypedDataSetGenerator", "4.0.0.0")]
        [global::System.ComponentModel.Design.HelpKeywordAttribute("vs.data.TableAdapter")]
        public virtual int Update(CountryDataSet.PaisDataTable dataTable) {
